...
import { v as t, x as n } from "./vendor-react.js";
import { it as r } from "./vendor-ui.js";
var i = e(n(), 1);
function a(e) {
  var t,
    n,
...
var s = (e) => (typeof e == `boolean` ? `${e}` : e === 0 ? `0` : e),
  ...
  h = (e) => {
    ...
    return (
      y(Object.entries(e.classGroups), n).forEach(([e, n]) => {
        g(n, r, e, t);
      }),
      r
    );
  ...
  w = (e) => ({ cache: b(e.cacheSize), parseClassName: S(e), ...d(e) }),
  T = /\s+/,
  E = (e, t) => {
    let {
      parseClassName: n,
...
var A = (e) => {
  ...
  z = (e) => V(e) || N.has(e) || M.test(e),
  B = (e) => q(e, `length`, se),
  V = (e) => !!e && !Number.isNaN(Number(e)),
  H = (e) => q(e, `number`, V),
  U = (e) => !!e && Number.isInteger(Number(e)),
  ee = (e) => e.endsWith(`%`) && V(e.slice(0, -1)),
  W = (e) => j.test(e),
  G = (e) => P.test(e),
  te = new Set([`length`, `size`, `percentage`]),
  ne = (e) => q(e, te, ce),
  re = (e) => q(e, `position`, ce),
    ...
    return {
      ...
      classGroups: {
        ...
        "text-decoration-thickness": [
          { decoration: [`auto`, `from-font`, z, B] },
        ],
        "underline-offset": [{ "underline-offset": [`auto`, z, W] }],
        ...
        "bg-size": [{ bg: [`auto`, `cover`, `contain`, ne] }],
        "bg-image": [
          {
            bg: [
              `none`,
...
var pe = t(),
  ...
  he = i.forwardRef(
    ({ className: e, variant: t, size: n, asChild: i = !1, ...a }, o) =>
      (0, pe.jsx)(i ? r : `button`, {
        className: fe(
          me({ variant: t, size: n, className: e }),
          `active:scale-95 transition-all duration-200 ease-in-out hover:shadow-md`,
        ),
        ref: o,
        ...a,
      }),
...
var J = [
    ...
    packages: [
      {
        ...
        itinerary: [
          ...
          },
          {
            ...
            activities: [`Hotel check-out`, `Transfer to Port Blair Airport`],
          },
        ],
      },
      {
  ...
  },
  {
    ...
    packages: [
      ...
      {
        id: `kar-2n3d-chikmagalur`,
        duration: `2 Nights 3 Days (Chikmagalur)`,
        nights: 2,
        days: 3,
        price: 11999,
        image: `kar_adventure_2.jpg`,
        inclusions: [
          `Pickup & Drop at Bengaluru`,
          `3 Days Private vehicle for sightseeing`,
          `2 Night Accommodation at Chikmagalur`,
        ...
        itinerary: [
          {
            ...
            description: `Journey from Bengaluru and explore the hills of Chikmagalur.`,
            activities: [
              `Pickup from Bengaluru`,
              `Visit Mullayanagiri`,
              `Explore Jhari Falls & Baba Budangiri`,
              `Visit Manikyadhara Falls & Hirekolale lake`,
              `Visit Coffee Museum`,
          ...
          },
          {
            ...
            description: `A day filled with waterfalls and scenic viewpoints.`,
            activities: [
              `Visit Hebbe Falls`,
              `Explore Kemmangundi and Z point`,
              `Visit Ayyanakere Lake & Amrutesvara temple`,
              `Overnight stay at Chikmagalur`,
            ],
          },
          {
            day: 3,
            title: `Nature Trails & Departure`,
            description: `Explore the national park and return to Bengaluru.`,
            activities: [
              `Check out from Hotel`,
              `Visit Kudremukh National Park`,
              `Explore Hanuman Gundi Falls`,
              `Seek blessings at Sringeri Mutt`,
              `Towards Bengaluru and Drop at Bengaluru`,
            ],
          },
        ],
      },
...
var Z = {
  login: (e, t) =>
    fetch(`${Y}/auth/login`, {
      ...
      if (!e.ok) throw Error(`Login failed`);
      return e.json();
    }),
  getDestinations: () =>
    fetch(`${Y}/destinations`).then((e) => {
      if (!e.ok) throw Error(`Failed to fetch destinations`);
      return e.json();
    }),
  createDestination: (e, t) =>
    fetch(`${Y}/destinations`, {
      method: `POST`,
      headers: X(t),
      body: JSON.stringify(e),
    }).then((e) => {
      if (!e.ok) throw Error(`Failed to create destination`);
      return e.json();
    }),
  updateDestination: (e, t, n) =>
    fetch(`${Y}/destinations/${e}`, {
      method: `PUT`,
      headers: X(n),
      body: JSON.stringify(t),
    }).then((e) => {
      if (!e.ok) throw Error(`Failed to update destination`);
      return e.json();
    }),
  deleteDestination: (e, t) =>
    fetch(`${Y}/destinations/${e}`, { method: `DELETE`, headers: X(t) }).then(
      (e) => {
        if (!e.ok) throw Error(`Failed to delete destination`);
        return e.json();
      },
    ),
  getContent: (e) =>
    fetch(`${Y}/content/${e}`).then((t) => {
      if (!t.ok) throw Error(`Failed to fetch content for ${e}`);
      return t.json();
    }),
  updateContent: (e, t, n) =>
    fetch(`${Y}/content/${e}`, {
      ...
      if (!t.ok) throw Error(`Failed to update content for ${e}`);
      return t.json();
    }),
  upload: (e, t, n) => {
    let r = new FormData();
    return (
      ...
      fetch(`${Y}/upload`, {
        ...
        if (!e.ok) throw Error(`Failed to upload file`);
        return e.json();
      })
    );
  },
  parsePackageDocument: (e, t) => {
    let n = new FormData();
    return (
      n.append(`file`, e),
      fetch(`${Y}/parse-package-document`, {
        method: `POST`,
        ...
        let t = await e.json();
        if (!e.ok)
          throw Error(t.message || `Failed to parse package document`);
        return t;
      })
    );
  },
},
  ge = (0, i.createContext)(void 0),
  _e = [
    {
      id: `stranger-kashmir`,
  ...
  ve = [
    {
      id: `rev-1`,
      name: `Vignesh Kumar`,
      text: `Had an amazing trip to Thailand planned by Planet Life Madurai. Everything was seamless!`,
    },
    {
      id: `rev-2`,
      name: `Priyadharshini`,
      text: `Excellent service and professional approach. They customized our Dubai package perfectly.`,
    },
    {
      id: `rev-3`,
      name: `Mohamed Ibrahim`,
      text: `Superb experience! Our Bali trip was unforgettable. Thank you team!`,
    },
    {
      id: `rev-4`,
      name: `Ananya R`,
      text: `Very transparent pricing and great selection of packages. Loved the Vietnam tour.`,
    },
    {
      id: `rev-5`,
      name: `Sathish Kumar`,
      text: `Best decision for our family trip. Hassle-free experience and top-notch hospitality.`,
    },
    {
      id: `rev-6`,
      name: `Karthik Raja`,
      text: `Best customized international trips. Their attention to detail is impressive.`,
    },
    {
      id: `rev-7`,
      name: `Arun Prasath`,
      text: `Thailand trip was just amazing. The guidance provided was very professional.`,
    },
    {
      id: `rev-8`,
      name: `Deepika M`,
      text: `Everything from visa to stay was well managed. Planet Life is the best in Madurai.`,
    },
    {
      id: `rev-9`,
      name: `Rahul Singh`,
      text: `Had a great time in Singapore. Transparent pricing and no hidden costs.`,
    },
    {
      id: `rev-10`,
      name: `Meera Krishnan`,
      text: `Highly recommends for international tours. Their team is always available for support.`,
    },
    {
      id: `rev-11`,
      name: `Suresh Babu`,
      text: `The customized itinerary was perfect. Enjoyed every bit of our holiday.`,
    },
    {
      id: `rev-12`,
      name: `Swathi`,
      text: `Friendly staff and excellent tour coordination. Truly a stress-free travel experience.`,
    },
  ],
  ye = [
    { id: `stat-1`, number: `20000+`, label: `Happy Travelers` },
    { id: `stat-2`, number: `100+`, label: `Destinations` },
    { id: `stat-3`, number: `4.9`, label: `Google Rating` },
    { id: `stat-4`, number: `24/7`, label: `Support Available` },
  ],
  be = [
    {
      id: `val-1`,
  ...
  xe = [
    {
      ...
      icon: `Briefcase`,
      image: `corporate_trips.png`,
      desc: `Professional itineraries designed for team building, offsites, and corporate retreats with top-tier amenities.`,
    },
    {
      id: `trip-2`,
      title: `Private Trips`,
      icon: `ShieldCheck`,
      image: `private_trips.png`,
      desc: `Exclusive, personalized journeys offering ultimate privacy, luxury, and tailor-made experiences.`,
    },
    {
      id: `trip-3`,
      title: `Strangers Trips`,
      icon: `Users`,
      image: `strangers_trips.png`,
      desc: `Join a group of like-minded solo travelers for an adventure of a lifetime and make lasting friendships.`,
    },
    {
      id: `trip-4`,
      title: `Couples Trips`,
      icon: `Heart`,
      image: `couples_trips.png`,
      desc: `Romantic getaways crafted perfectly for couples to celebrate honeymoons, anniversaries, or just each other.`,
    },
    {
      id: `trip-5`,
      title: `College Trips`,
      icon: `GraduationCap`,
      image: `college_trips.png`,
      desc: `Budget-friendly, action-packed group tours perfect for students looking for fun and exploration.`,
    },
    {
      id: `trip-6`,
      title: `Family Trips`,
      icon: `Home`,
      image: `family_trips.png`,
      desc: `Wholesome holiday packages designed to bring families together with activities suitable for all ages.`,
    },
  ],
  Se = [
    { id: `gal-1`, src: `bali_adventure_1.jpg`, alt: `Bali scenery` },
    { id: `gal-2`, src: `thailand_adventure_1.jpg`, alt: `Thailand temple` },
    { id: `gal-3`, src: `dubai_adventure_1.jpg`, alt: `Dubai skyline` },
    { id: `gal-4`, src: `singapore_main_new.jpg`, alt: `Singapore gardens` },
    { id: `gal-5`, src: `vietnam_main.jpg`, alt: `Vietnam landscape` },
    { id: `gal-6`, src: `malaysia_profile_new.jpg`, alt: `Malaysia city` },
  ],
  Q = {
...
With thousands of satisfied travelers and a 4.9 Google rating, we've established ourselves as a trusted name in premium travel. Our passion is your adventure, and we're here to make your dream vacation a reality.`,
  ...
  Ce = {
    ...
    facebook: `#`,
    youtube: `https://youtube.com/@planetlife_travel?si=vGj7zOIsZloGrwYh`,
    twitter: `#`,
  },
  we = {
  ...
  Te = ({ children: e }) => {
    ...
    (0, i.useEffect)(() => {
      (async () => {
        try {
          let e = localStorage.getItem(`isAdminAuthenticated`),
            t = localStorage.getItem(`adminToken`);
          e === `true` && t && n(!0);
          let r = localStorage.getItem(`planetlife_destinations`);
          if (r)
            try {
              let e = JSON.parse(r);
              a(Array.isArray(e) ? e : J);
            } catch {
              a(J);
            }
          else a(J);
          let [i, o, s, c, u] = await Promise.all([
            Z.getDestinations().catch(() => null),
            Z.getContent(`home`).catch(() => ({ data: Q })),
            Z.getContent(`about`).catch(() => ({ data: $ })),
            Z.getContent(`contact`).catch(() => ({ data: Ce })),
            Z.getContent(`packages`).catch(() => ({ data: we })),
          ]);
          if (i && Array.isArray(i))
            (a(i),
              localStorage.setItem(
                `planetlife_destinations`,
                JSON.stringify(i),
              ));
          else {
            let e = localStorage.getItem(`planetlife_destinations`);
            if (e)
              try {
                let t = JSON.parse(e);
                a(Array.isArray(t) ? t : J);
              } catch {
                a(J);
              }
            else a(J);
          ...
          let f = { ...Q, ...(o.data || {}) },
            m = { ...$, ...(s.data || {}) },
            g = { ...Ce, ...(c.data || {}) };
          (l(f), d(m), p(g), h({ ...we, ...(u.data || {}) }));
        } catch (e) {
          (console.error(`Error loading data from API:`, e),
            localStorage.getItem(`planetlife_destinations`) || a(J));
        } finally {
          s(!1);
        }
      })();
    }, []);
    let g = () => localStorage.getItem(`adminToken`) || ``,
      _ = async (e, t) => {
        try {
          let { token: r } = await Z.login(e, t);
          return (
            n(!0),
            localStorage.setItem(`isAdminAuthenticated`, `true`),
            localStorage.setItem(`adminToken`, r),
            !0
          );
        } catch (e) {
          throw e;
      ...
      y = (e) => {
        (a(e),
          localStorage.setItem(`planetlife_destinations`, JSON.stringify(e)));
      };
    return (0, pe.jsx)(ge.Provider, {
      value: {
        isAuthenticated: t,
        login: _,
        logout: v,
        ...
        addDestination: async (e) => {
          try {
            let t = await Z.createDestination(e, g());
            y([...r, t]);
          } catch (e) {
            console.error(`Error creating destination`, e);
          }
        },
        updateDestination: async (e) => {
          try {
            let t = await Z.updateDestination(e.id, e, g());
            y(r.map((e) => (e.id === t.id ? t : e)));
          } catch (e) {
            console.error(`Error updating destination`, e);
          }
        },
        deleteDestination: async (e) => {
          try {
            (await Z.deleteDestination(e, g()), y(r.filter((t) => t.id !== e)));
          } catch (e) {
            console.error(`Error deleting destination`, e);
          }
        },
        homeContent: c,
        updateHomeContent: async (e) => {
          (await Z.updateContent(`home`, e, g()), l(e));
        },
        aboutContent: u,
        updateAboutContent: async (e) => {
          (await Z.updateContent(`about`, e, g()), d(e));
        },
        contactContent: f,
        updateContactContent: async (e) => {
          (await Z.updateContent(`contact`, e, g()), p(e));
        },
        packagesContent: m,
        updatePackagesContent: async (e) => {
          (await Z.updateContent(`packages`, e, g()), h(e));
        },
        isLoading: o,
      },
      children: e,
  ...
  Ee = () => {
    let e = (0, i.useContext)(ge);
    if (e === void 0)
      throw Error(`useAdmin must be used within an AdminProvider`);
    return e;
  };
export { fe as a, he as i, Ee as n, l as o, Z as r, Te as t };
