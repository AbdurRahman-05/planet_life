...
import { c as t, n, s as r, v as i, x as a } from "./vendor-react.js";
...
import { n as w, t as T } from "./card.js";
var E = e(a(), 1),
  ...
  A = () => {
    let { packageId: e } = t(),
      i = r(),
      { toast: a } = _(),
      { destinations: x, isLoading: D, contactContent: A } = s(),
      [j, M] = (0, E.useState)(1),
      [N, P] = (0, E.useState)(!1);
    (0, E.useEffect)(() => {
      (window.scrollTo(0, 0), M(1));
    }, [e]);
    let [F, I] = (0, E.useState)({
        travelMonth: ``,
        duration: ``,
        numPersons: ``,
        name: ``,
      ...
      R =
        ...
        (L.id.toLowerCase().includes(`stranger`) ||
          ...
          L.destinationName.toLowerCase().includes(`stranger`));
    if (D)
      return (0, O.jsx)(`div`, {
        className: `min-h-screen pt-20 flex items-center justify-center bg-[#0a0a0a] font-sans`,
    ...
    if (!L)
      return (0, O.jsx)(`div`, {
        className: `min-h-screen pt-20 flex items-center justify-center font-sans`,
        children: (0, O.jsxs)(`div`, {
          className: `text-center`,
          children: [
            (0, O.jsx)(`h1`, {
              className: `text-4xl font-extrabold mb-4 uppercase`,
              children: `Package Not Found`,
            }),
            (0, O.jsx)(o, {
              asChild: !0,
              className: `bg-red-600 hover:bg-black text-white px-8 py-6 rounded-full uppercase font-bold tracking-widest transition-all`,
              children: (0, O.jsx)(n, {
                to: `/destinations`,
          ...
          (0, O.jsxs)(`div`, {
            ...
            children: [
              (0, O.jsx)(o, {
                variant: `ghost`,
                asChild: !0,
                className: `mb-6 text-white hover:text-white hover:bg-white/20 uppercase font-black tracking-widest text-xs`,
                children: (0, O.jsxs)(n, {
                  to: `/destination/${L.destinationId}`,
                  children: [
                    (0, O.jsx)(u, { className: `mr-2 h-4 w-4` }),
                    `Back to Package`,
                  ],
                }),
              }),
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsx)(`h1`, {
                    className: `text-2xl xs:text-3xl mobile:text-4xl md:text-5xl lg:text-7xl font-bold mb-4 mobile:mb-6 md:mb-8 uppercase tracking-tighter leading-tight font-heading`,
                    children: R
                      ? `${L.destinationName} Strangers Tour`
                      : L.duration,
                  }),
                  (0, O.jsx)(`p`, {
                    className: `max-w-2xl mx-auto text-white/80 text-sm mobile:text-base md:text-lg lg:text-xl font-medium leading-relaxed`,
                    children: R
                      ? `Secure your spot for an exciting group experience in ${L.destinationName}. Meet like-minded travelers!`
                      : `Secure your spot for an unforgettable experience in ${L.destinationName}. Custom planning at your fingertips.`,
                  }),
                ],
              }),
              (0, O.jsxs)(`div`, {
                        ...
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsx)(`h3`, {
                              ...
                              children: R
                                ? `Secure Your Strangers Group Adventure`
                                ...
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsxs)(C, {
                                      ...
                                      children: [
                                        (0, O.jsx)(c, { className: `w-4 h-4` }),
                                        ` Travel Month`,
                                      ],
                                    }),
                                    (0, O.jsxs)(y, {
                                      value: F.travelMonth,
                                      onValueChange: (e) => B(`travelMonth`, e),
                                      children: [
                                        (0, O.jsx)(h, {
                                ...
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsxs)(C, {
                                      className: `text-red-600 font-extrabold uppercase text-[10px] flex items-center gap-2`,
                                      children: [
                                        (0, O.jsx)(f, { className: `w-4 h-4` }),
                                        ` Duration`,
                                      ],
                                    }),
                                    (0, O.jsxs)(y, {
                                      value: F.duration,
                                      onValueChange: (e) => B(`duration`, e),
                                      children: [
                                        (0, O.jsx)(h, {
                                          className: `bg-gray-50 border-gray-100 text-gray-900 h-12 rounded-xl`,
                                          children: (0, O.jsx)(b, {
                                ...
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsxs)(C, {
                                      className: `text-red-600 font-extrabold uppercase text-[10px] flex items-center gap-2`,
                                      children: [
                                        (0, O.jsx)(d, { className: `w-4 h-4` }),
                                        ` Number of Persons`,
                                      ],
                                    }),
                                    (0, O.jsxs)(y, {
                                      value: F.numPersons,
                                      onValueChange: (e) => B(`numPersons`, e),
                                      children: [
                                        (0, O.jsx)(h, {
                                          className: `bg-gray-50 border-gray-100 text-gray-900 h-12 rounded-xl`,
                                          children: (0, O.jsx)(b, {
                              ...
                              children: [
                                ...
                                (0, O.jsx)(o, {
                                  onClick: async (e) => {
                                    ...
                                    P(!0);
                                    let t = `*Tour Booking Request - Planet Life${R ? ` (Strangers Trip)` : ``}%0A%0A*Package:* ${L.duration}%0A*Destination:* ${L.destinationName}%0A*Type:* ${R ? `Strangers Trip (Group Tour)` : `Custom Trip`}%0A*Name:* ${F.name}%0A*WhatsApp:* ${F.whatsapp}%0A*Email:* ${F.email}%0A*Month:* ${F.travelMonth}%0A*Duration:* ${F.duration}%0A*Persons:* ${F.numPersons}%0A*Preferred Language:* ${F.language}`,
                                      n = A.phone.replace(/[^0-9]/g, ``),
                                      r = `https://wa.me/${n.length === 10 ? `91${n}` : n}?text=${t}`;
                                    (await new Promise((e) =>
                                      setTimeout(e, 800),
                                    ),
                                      a({
