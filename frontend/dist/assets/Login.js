...
import { c as o, m as s, s as c } from "./index.js";
import { i as l, n as u, r as d, t as f } from "./card.js";
var p = e(r(), 1),
  m = n(),
  h = () => {
            ...
            children: (0, m.jsxs)(`form`, {
              onSubmit: async (t) => {
                ...
                try {
                  ...
                  s.error(e.message || `Invalid credentials`);
                } finally {
                  _(!1);
                }
              },
              ...
              children: [
                (0, m.jsxs)(`div`, {
                  className: `space-y-2`,
                  children: [
                    (0, m.jsx)(c, { htmlFor: `email`, children: `Email` }),
                    (0, m.jsx)(o, {
                      id: `email`,
                      type: `email`,
                      value: e,
