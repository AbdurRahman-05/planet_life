...
import { a as r, i } from "./AdminContext.js";
import { H as a, U as o } from "./lucide-react.js";
var s = e(n());
function c(e) {
...
function x(e, t) {
  return e === 0 || t === 0 || v(e) <= v(t) ? 0 : v(b(v(e), v(t)) / e);
}
function S(e) {
  return Math.round(e * 100) / 100;
}
function C(e) {
  return O(e).map(Number);
}
function w(e) {
  return e[T(e)];
}
...
function ne(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, _, S, C) {
  let { cross: w, direction: T } = e,
    E = [`INPUT`, `SELECT`, `TEXTAREA`],
    D = { passive: !1 },
    O = M(),
    k = M(),
    j = N(50, 225).constrain(p.measure(20)),
  ...
  function ue(e) {
    if (!A(e, r) && e.touches.length >= 2) return V(e);
    let t = a.readPoint(e),
      n = a.readPoint(e, w),
      o = b(t, re),
      c = b(n, F);
  ...
  return { init: ie, destroy: ae, pointerDown: de };
}
function re(e, t) {
  let n, r;
  function i(e) {
...
function z(e, t, n, r, i) {
  ...
  function u(i) {
    if (!l()) return;
    let c = v(e[e.reachedMin(t.get()) ? `min` : `max`] - t.get()),
      u = n.get() - t.get(),
      d = s.constrain(c / o);
    (n.subtract(u * d),
      !i &&
    ...
    return n.length === 1
      ...
      : i
        ...
        : r.slice(s, c).map((e, t, n) => {
            let r = !t,
              i = E(n, t);
            return r ? D(w(n[0]) + 1) : i ? D(T(a) - w(n)[0] + 1, w(n)[0]) : e;
          });
  }
...
function le(e, t, n, r, i) {
  ...
  function u(t, r) {
    ...
    if (!e) return t;
    if (!r) return c(i);
    let a = i.filter((e) => y(e) === r);
    return a.length ? c(a) : w(i) - n;
  }
  function d(e, n) {
...
function V(e, t, n, r, i, a, o, s) {
  ...
  function u(u) {
    ...
    function f(t) {
      ...
      m(a) && (i.useDuration(0), r.index(a, 0), o.emit(`slideFocus`));
    }
...
function _e(e, t, n, r, i, a, o) {
  let {
    ...
    W = ge(k, A, g, d, D, O, xe, U, 2),
    { snaps: G, snapsAligned: Se } = B(k, _e, D, O, W),
    K = -w(G) + w(be),
    { snapsContained: Ce, scrollContainLimit: we } = ie(A, K, Se, v, 2),
    q = ve ? Ce : Se,
    { limit: J } = ae(K, q, d),
    Y = P(T(q), u, d),
    Te = Y.clone(),
    ...
    $ = R(je, Z, Me, Q, f, Ae),
    Ne = le(d, q, K, J, Q),
    Pe = ue(ke, Y, Te, $, Ne, Q, o),
    Fe = se(J),
    Ie = M(),
    Le = me(t, n, o, h),
    { slideRegistry: Re } = ce(ve, v, q, we, W, Ee),
    ze = V(e, n, Re, Pe, $, Ie, o, S),
    Be = {
      ownerDocument: r,
      ownerWindow: i,
      eventHandler: o,
      ...
      previousLocation: Me,
      options: a,
      resizeHandler: L(t, o, i, n, k, y, E),
      scrollBody: $,
      scrollBounds: z(J, Z, Q, $, N),
      scrollLooper: oe(K, J, Z, [je, Z, Me, Q]),
      scrollProgress: Fe,
      scrollSnapList: q.map(Fe.get),
      scrollSnaps: q,
      scrollTarget: Ne,
      scrollTo: Pe,
      slideLooper: fe(k, A, K, ye, be, G, q, Z, n),
      slideFocus: ze,
...
function U(e, t, n) {
  ...
  function T() {
    ...
    C = (h(t) ? e.querySelector(t) : t) || e.children[0];
    let r = h(n) ? C.querySelectorAll(n) : n;
    w = [].slice.call(r || C.children);
  }
  function E(t) {
    let n = _e(e, C, w, r, i, t, c);
...
function W(e = {}, t = []) {
  ...
  return (
    (0, s.useEffect)(() => {
      d(n.current, e) || ((n.current = e), l());
    }, [e, l]),
    (0, s.useEffect)(() => {
      p(r.current, t) || ((r.current = t), l());
    }, [t, l]),
    (0, s.useEffect)(() => {
      if (u() && o) {
        U.globalOptions = W.globalOptions;
        let e = U(o, n.current, r.current);
...
var Ce = s.forwardRef(
  (
    ...
    let [u, d] = W({ ...t, axis: e === `horizontal` ? `x` : `y` }, i),
      [f, p] = s.useState(!1),
      [m, h] = s.useState(!1),
      g = s.useCallback((e) => {
      ...
      y = s.useCallback(
        (e) => {
          e.key === `ArrowLeft`
            ? (e.preventDefault(), _())
            : e.key === `ArrowRight` && (e.preventDefault(), v());
        },
        [_, v],
      );
    return (
...
Ce.displayName = `Carousel`;
var we = s.forwardRef(({ className: e, ...t }, n) => {
  let { carouselRef: i, orientation: a } = K();
  return (0, G.jsx)(`div`, {
    ref: i,
    className: `overflow-hidden`,
    children: (0, G.jsx)(`div`, {
      ref: n,
      className: r(`flex`, a === `horizontal` ? `-ml-4` : `-mt-4 flex-col`, e),
      ...t,
    }),
  });
});
we.displayName = `CarouselContent`;
var q = s.forwardRef(({ className: e, ...t }, n) => {
  let { orientation: i } = K();
  return (0, G.jsx)(`div`, {
    ref: n,
    role: `group`,
...
var J = s.forwardRef(
  ({ className: e, variant: t = `outline`, size: n = `icon`, ...a }, s) => {
    let { orientation: c, scrollPrev: l, canScrollPrev: u } = K();
    return (0, G.jsxs)(i, {
      ref: s,
      variant: t,
      size: n,
...
var Y = s.forwardRef(
  ({ className: e, variant: t = `outline`, size: n = `icon`, ...o }, s) => {
    let { orientation: c, scrollNext: l, canScrollNext: u } = K();
    return (0, G.jsxs)(i, {
      ref: s,
      variant: t,
      size: n,
      ...
      ...o,
      children: [
        (0, G.jsx)(a, { className: `h-4 w-4` }),
        (0, G.jsx)(`span`, { className: `sr-only`, children: `Next slide` }),
      ],
    });
  },
);
...
function Oe(e = {}) {
  ...
  function d(a, o) {
    ...
    if (
      ((t = c(s(s(Te, Oe.globalOptions), e))), n.scrollSnapList().length <= 1)
    )
      return;
    ((u = t.jump), (r = !1), (i = Ee(n, t.delay)));
    ...
    (l.add(d, `visibilitychange`, _),
      ...
      t.stopOnFocusIn &&
        !t.stopOnInteraction &&
        l.add(n.containerNode(), `focusout`, h),
      t.playOnInit && h());
  }
  function f() {
...
export { Y as a, q as i, Ce as n, J as o, we as r, Oe as t };
