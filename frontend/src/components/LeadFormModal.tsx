...
import leadFormBanner from "@/assets/lead_form_banner.png";
...
export const LeadFormModal: React.FC<LeadFormModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-[420px] w-[95vw] bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-white/20 overflow-hidden p-0">
        {/* Banner Image Header */}
        <div className="w-full h-32 sm:h-36 overflow-hidden relative">
          ...
          <div className="absolute bottom-3 left-4 text-white">
            <span className="bg-red-600 text-white text-[9px] font-black uppercase tracking-[0.25em] px-2.5 py-1 rounded-full shadow-md">
              Planet Life
            </span>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-6 space-y-4">
          <DialogHeader className="text-left mb-2">
            ...
            <DialogTitle className="text-lg sm:text-xl font-bold text-foreground font-heading uppercase">
